...
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','scribe.title','scribe.description','scribe.base_url',
...
'scribe.auth.name','scribe.auth.use_value','scribe.auth.placeholder','scribe.auth.extra_info','scribe.intro_text',
'scribe.example_languages','scribe.postman.enabled','scribe.postman.overrides','scribe.openapi.enabled','scribe.openapi.overrides',
'scribe.groups.default','scribe.groups.order','scribe.logo','scribe.last_updated','scribe.examples.faker_seed',
'scribe.examples.models_source','scribe.strategies.metadata','scribe.strategies.urlParameters','scribe.strategies.queryParameters','scribe.strategies.headers',
'scribe.strategies.headers.2','scribe.strategies.headers.2.1.Content-Type','scribe.strategies.headers.2.1.Accept','scribe.strategies.bodyParameters','scribe.strategies.responses',
'scribe.strategies.responses.5','scribe.strategies.responses.5.1.only','scribe.strategies.responses.5.1.config.app.debug','scribe.strategies.responseFields','scribe.database_connections_to_transact',
'scribe.fractal.serializer','scribe.routeMatcher','scribe_new.__configVersion','scribe_new.theme','scribe_new.title',
'scribe_new.description','scribe_new.base_url','scribe_new.type','scribe_new.static.output_path','scribe_new.try_it_out.enabled',
'scribe_new.try_it_out.base_url','scribe_new.try_it_out.use_csrf','scribe_new.try_it_out.csrf_url','scribe_new.postman.enabled','scribe_new.postman.overrides',
'scribe_new.openapi.enabled','scribe_new.openapi.overrides','scribe_new.intro_text','scribe_new.example_languages','scribe_new.logo',
'scribe_new.last_updated','scribe_new.groups.order','scribe_new.groups.default','scribe_new.examples.faker_seed','scribe_new.examples.models_source',
'scribe_new.routeMatcher','scribe_new.database_connections_to_transact','scribe_new.fractal.serializer','scribe_new.auth.enabled','scribe_new.auth.default',
'scribe_new.auth.in','scribe_new.auth.name','scribe_new.auth.use_value','scribe_new.auth.placeholder','scribe_new.auth.extra_info',
'scribe_new.strategies.metadata','scribe_new.strategies.urlParameters','scribe_new.strategies.queryParameters','scribe_new.strategies.headers','scribe_new.strategies.headers.3',
'scribe_new.strategies.headers.3.1.Content-Type','scribe_new.strategies.headers.3.1.Accept','scribe_new.strategies.bodyParameters','scribe_new.strategies.responses','scribe_new.strategies.responses.5',
'scribe_new.strategies.responses.5.1.only','scribe_new.strategies.responses.5.1.except','scribe_new.strategies.responses.5.1.config.app.env','scribe_new.strategies.responses.5.1.queryParams','scribe_new.strategies.responses.5.1.bodyParams',
'scribe_new.strategies.responses.5.1.fileParams','scribe_new.strategies.responses.5.1.cookies','scribe_new.strategies.responseFields','scribe_new.routes.0.match.prefixes','scribe_new.routes.0.match.domains',
'scribe_new.routes.0.match.versions','scribe_new.routes.0.include','scribe_new.routes.0.exclude','ide-helper.filename','ide-helper.models_filename',
...
'shared-accesses.index','shared-accesses.store','shared-accesses.show','shared-accesses.update','shared-accesses.destroy','medias.index','medias.store','medias.show','medias.update',
'medias.destroy','pages.index','pages.store',
'pages.show','pages.update','pages.destroy','login','storage.local',);
