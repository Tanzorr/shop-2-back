...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\MediaServiceInterface' => \App\Services\MediaService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/oleksandr/Desktop/study/shop-2/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/oleksandr/Desktop/study/shop-2/public/storage','l5-swagger.default',
...
'broadcasting.connections.null.driver','view.paths','view.compiled','concurrency.default','cors.paths',
...
'excel.temporary_files.local_permissions','excel.temporary_files.remote_disk','excel.temporary_files.remote_prefix','excel.temporary_files.force_resync_remote','scribe.title',
'scribe.description','scribe.base_url','scribe.routes.0.match.prefixes','scribe.routes.0.match.domains','scribe.routes.0.match.versions',
...
'scribe.openapi.enabled','scribe.openapi.overrides','scribe.groups.default','scribe.groups.order','scribe.logo',
'scribe.last_updated','scribe.examples.faker_seed','scribe.examples.models_source','scribe.strategies.metadata','scribe.strategies.urlParameters',
'scribe.strategies.queryParameters','scribe.strategies.headers','scribe.strategies.headers.2','scribe.strategies.headers.2.1.Content-Type','scribe.strategies.headers.2.1.Accept',
'scribe.strategies.bodyParameters','scribe.strategies.responses','scribe.strategies.responses.5','scribe.strategies.responses.5.1.only','scribe.strategies.responses.5.1.config.app.debug',
'scribe.strategies.responseFields','scribe.database_connections_to_transact','scribe.fractal.serializer','scribe.routeMatcher','scribe_new.__configVersion',
'scribe_new.theme','scribe_new.title','scribe_new.description','scribe_new.base_url','scribe_new.type',
'scribe_new.static.output_path','scribe_new.try_it_out.enabled','scribe_new.try_it_out.base_url','scribe_new.try_it_out.use_csrf','scribe_new.try_it_out.csrf_url',
'scribe_new.postman.enabled','scribe_new.postman.overrides','scribe_new.openapi.enabled','scribe_new.openapi.overrides','scribe_new.intro_text',
'scribe_new.example_languages','scribe_new.logo','scribe_new.last_updated','scribe_new.groups.order','scribe_new.groups.default',
'scribe_new.examples.faker_seed','scribe_new.examples.models_source','scribe_new.routeMatcher','scribe_new.database_connections_to_transact','scribe_new.fractal.serializer',
'scribe_new.auth.enabled','scribe_new.auth.default','scribe_new.auth.in','scribe_new.auth.name','scribe_new.auth.use_value',
'scribe_new.auth.placeholder','scribe_new.auth.extra_info','scribe_new.strategies.metadata','scribe_new.strategies.urlParameters','scribe_new.strategies.queryParameters',
'scribe_new.strategies.headers','scribe_new.strategies.headers.3','scribe_new.strategies.headers.3.1.Content-Type','scribe_new.strategies.headers.3.1.Accept','scribe_new.strategies.bodyParameters',
'scribe_new.strategies.responses','scribe_new.strategies.responses.5','scribe_new.strategies.responses.5.1.only','scribe_new.strategies.responses.5.1.except','scribe_new.strategies.responses.5.1.config.app.env',
'scribe_new.strategies.responses.5.1.queryParams','scribe_new.strategies.responses.5.1.bodyParams','scribe_new.strategies.responses.5.1.fileParams','scribe_new.strategies.responses.5.1.cookies','scribe_new.strategies.responseFields',
'scribe_new.routes.0.match.prefixes','scribe_new.routes.0.match.domains','scribe_new.routes.0.match.versions','scribe_new.routes.0.include','scribe_new.routes.0.exclude',
...
'users.store','users.update','users.destroy','users.index','users.show',
'categories.index','categories.store','categories.show','categories.update','categories.destroy',
'products.index','products.store','products.show','products.update','products.destroy','orders.index',
'orders.store','orders.show','orders.update','orders.destroy','medias.index',
'medias.store','medias.show','medias.update','medias.destroy','pages.index','pages.store','pages.show','pages.update',
'pages.destroy','tags.index','tags.store','tags.show','tags.update',
'tags.destroy','login',
'storage.local',);
        registerArgumentsSet('views', 
'emails.annual_report','emails.cancel_unpaid_report','l5-swagger::index','vendor.l5-swagger.index','welcome',
