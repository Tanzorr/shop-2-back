...
'excel.temporary_files.remote_disk','excel.temporary_files.remote_prefix','excel.temporary_files.force_resync_remote','scribe.title','scribe.description',
...
'pages.show','pages.update','pages.destroy','tags.index','tags.store',
'tags.show','tags.update','tags.destroy','login','storage.local',);
